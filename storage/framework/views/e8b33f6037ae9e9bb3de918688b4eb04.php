...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Fashion Shop - Cửa Hàng Thời Trang'); ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            ...
            <!-- Search Form -->
            <form class="search-form d-none d-lg-flex" method="GET" action="<?php echo e(route('search')); ?>">
...
</html><?php /**PATH C:\Webbanhang\clothing-shop-master\clothing-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>